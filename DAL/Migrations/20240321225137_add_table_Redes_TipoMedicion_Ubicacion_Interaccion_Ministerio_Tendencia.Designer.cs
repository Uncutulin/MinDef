...
namespace MinDef.Data.Migrations
{
    ...
    [Migration("20240321225137_add_table_Redes_TipoMedicion_Ubicacion_Interaccion_Ministerio_Tendencia")]
    partial class add_table_Redes_TipoMedicion_Ubicacion_Interaccion_Ministerio_Tendencia
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Interacciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Ministerios", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Redes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Tendencias", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.TipoMediciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("TipoMediciones");
                });

            modelBuilder.Entity("DAL.Models.Comunicacion.Ubicaciones", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Interacciones", b =>
                {
                    b.HasOne("DAL.Models.Comunicacion.Redes", "Red")
                        .WithMany()
                        .HasForeignKey("RedId");

                    b.HasOne("DAL.Models.Comunicacion.TipoMediciones", "TipoMedicion")
                        .WithMany()
                        .HasForeignKey("TipoMedicionId");

                    b.HasOne("DAL.Models.Comunicacion.Ubicaciones", "Ubicacion")
                        .WithMany()
            ...
            modelBuilder.Entity("DAL.Models.Comunicacion.Tendencias", b =>
                {
                    b.HasOne("DAL.Models.Comunicacion.Ministerios", "Ministerio")
                        .WithMany()
