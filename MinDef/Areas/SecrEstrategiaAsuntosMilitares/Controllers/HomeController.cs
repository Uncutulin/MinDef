...
namespace MinDef.Areas.SecrEstrategiaAsuntosMilitares.Controllers
{
    [Area("SecrEstrategiaAsuntosMilitares")]
    public class HomeController : MinDefBaseController
    {
        protected IContenedorTrabajo<Acciones> _unitWork;
        protected string codOrganismo = "SecrEstAsMil";
        ...
        {
            ViewBag.Titulo = "Secretaría de Estrategia y Asuntos Militares";
