...
namespace MinDef.Areas.SubSecrPlaneamientoOperativoCoordinacionEjecutivaEmergencias.Controllers
{
    [Area("SubSecrPlaneamientoOperativoCoordinacionEjecutivaEmergencias")]
    public class AccionesController : MinDefBaseController
    {
        ...
        protected string codOrganismo = "SubsPlanOpCoorEjeEmerg";
        ...
        {
            ViewBag.Titulo = "Subsecretaría de Planeamiento Operativo y Coordinación Ejecutiva en Emergencia";
            return View();
        }
