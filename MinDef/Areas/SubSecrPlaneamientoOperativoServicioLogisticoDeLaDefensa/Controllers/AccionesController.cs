...
namespace MinDef.Areas.SubSecrPlaneamientoOperativoServicioLogisticoDeLaDefensa.Controllers
{
    [Area("SubSecrPlaneamientoOperativoServicioLogisticoDeLaDefensa")]
    public class AccionesController : MinDefBaseController
    {
        ...
        protected string codOrganismo = "SubsPlanOpServLogDef";
        ...
        {
            ViewBag.Titulo = "Subsecretaría de Planeamiento Operativo y Servicio Logístico de la Defensa";
            return View();
        }
