...
namespace MinDef.Areas.SubSecrPlaneamientoEstrategicoPoliticoMilitar.Controllers
{
    [Area("SubSecrPlaneamientoEstrategicoPoliticoMilitar")]
    public class HomeController :  MinDefBaseController

    {
        protected IContenedorTrabajo<Acciones> _unitWork;
        protected string codOrganismo = " SubsPlanEstPolMil";
        ...
        {
            ViewBag.Titulo = "Subsecretaría de Planeamiento Estratégico y Política Militar";
